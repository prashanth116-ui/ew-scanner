...
export function scoreDemandEmergence(data: PreRunStockData): ComponentResult {
  ...
  if (clv !== null) {
    ...
    slots.push({ label: "close_location", earned, possible: 24, hasData: true });
  } else {
    slots.push({ label: "close_location", earned: 0, possible: 0, hasData: false });
  }
  ...
  if (data.pocketPivots !== null) {
    ...
    slots.push({ label: "pocket_pivots", earned, possible: 24, hasData: true });
  } else {
    slots.push({ label: "pocket_pivots", earned: 0, possible: 0, hasData: false });
  }
  ...
  if (data.rvolTrajectory !== null) {
    ...
    slots.push({ label: "rvol_trajectory", earned, possible: 16, hasData: true });
  } else {
    slots.push({ label: "rvol_trajectory", earned: 0, possible: 0, hasData: false });
  }

  // OBV divergence (0-14) — stealth accumulation
  if (data.obvDivergent !== null) {
    slots.push({ label: "obv_divergence", earned: data.obvDivergent ? 14 : 0, possible: 14, hasData: true });
    if (data.obvDivergent) evidence.push("OBV near the top of its range while price is not — stealth buying");
  } else {
    slots.push({ label: "obv_divergence", earned: 0, possible: 0, hasData: false });
  }
  ...
  if (data.moneyFlowPersistence !== null) {
    ...
    slots.push({ label: "money_flow_persistence", earned, possible: 10, hasData: true });
  } else {
    slots.push({ label: "money_flow_persistence", earned: 0, possible: 0, hasData: false });
  }
  ...
  if (data.pctFromBaseHigh !== null && atrPct !== null && atrPct > 0) {
    ...
    slots.push({ label: "distance_to_breakout", earned, possible: 12, hasData: true });
  } else {
    slots.push({ label: "distance_to_breakout", earned: 0, possible: 0, hasData: false });
  }
