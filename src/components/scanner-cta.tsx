...
const scanners = [
  ...
  },
  {
    ...
    description:
      "Multi-bagger candidates scored across 18 criteria — beaten-down stocks with structural catalysts.",
    icon: TrendingUp,
    color: "#10b981",
  },
  {
  ...
  },
  {
    ...
    description:
      "AI infrastructure spike detector — 17-factor scoring across 76 tickers with fire drill alerts and miss classification.",
    icon: Flame,
    color: "#ef4444",
  },
];
