...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: `${BASE}/sectors/guide`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    { url: `${BASE}/rotation`, changeFrequency: "daily", priority: 0.7 },
    {
      url: `${BASE}/confluence`,
      changeFrequency: "daily",
      priority: 0.9,
    ...
    {
      url: `${BASE}/confluence/guide`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    { url: `${BASE}/strat`, changeFrequency: "daily", priority: 0.9 },
    { url: `${BASE}/strat/guide`, changeFrequency: "weekly", priority: 0.7 },
    {
      url: `${BASE}/strat/watchlist`,
      changeFrequency: "daily",
      priority: 0.5,
    },
    { url: `${BASE}/earnings`, changeFrequency: "daily", priority: 0.8 },
    {
      url: `${BASE}/earnings/calendar`,
      changeFrequency: "daily",
      priority: 0.7,
    },
    { url: `${BASE}/catalyst`, changeFrequency: "daily", priority: 0.9 },
    {
      url: `${BASE}/catalyst/guide`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
